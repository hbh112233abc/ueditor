...
UE.I18N['en'] = {
    ...
    'insertaudio' : {
        ...
        'errorHttp' : 'Http Error',
        'errorServerUpload' : 'Server Result Error.',
        'remoteLockError' : "Remote Lock Error",
        'numError' : "Please enter the correct Num. e.g 123,400",
        'audioUrlError' : "The audio url format may be wrong!",
        'audioLoadError' : "audio load error",
        'searchRemind' : "please input search keyword",
        'searchLoading' : "search loading...",
        'searchRetry' : " :( ，sorry not found the audio,please retry!"
    },
    'webapp':{
